...
/**
 * Singleton script loader to prevent multiple Google Maps API loads.
 * Uses window-level flags to track loading state across all component instances.
 */
function loadMapScript(): Promise<void> {
  // If already loaded, return immediately
  if (window.__googleMapsScriptLoaded && window.google?.maps) {
  ...
  window.__googleMapsScriptLoading = new Promise<void>((resolve, reject) => {
    // Double-check if script was loaded while we were setting up
